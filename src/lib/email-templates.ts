...
export function getStudentPwaScannerWelcomeEmail(data: { name: string; email: string; scannerUrl: string }): string {
  return `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;margin:20px auto;background-color:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.05);border:1px solid #e2e8f0;">
        ...
        <tr>
          <td style="padding:40px 30px;">
            <h2 style="margin-top:0;font-size:20px;font-weight:700;color:#0f172a;">Halo ${data.name},</h2>
            <p style="font-size:15px;line-height:1.6;color:#475569;margin-bottom:20px;">
              Sekolah telah resmi mendaftarkan Anda ke **Sistem Presensi QR Code & Geolocation**. Anda kini dapat melakukan pemindaian presensi kelas secara langsung dan aman melalui ponsel pintar Anda masing-masing!
            </p>
            ...
            <div style="border-left:4px solid #6366f1;padding-left:15px;margin-bottom:30px;">
              ...
              <p style="margin:0;font-size:14px;color:#64748b;">
                Email: <strong style="color:#0f172a;">${data.email}</strong><br>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="margin:30px auto 10px;">
              <tr>
                <td align="center" style="background-color:#3b82f6;border-radius:14px;box-shadow:0 4px 14px rgba(59,130,246,0.4);">
                  <a href="${data.scannerUrl}" target="_blank" style="display:inline-block;padding:16px 32px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;">Buka & Pasang Scanner App</a>
                </td>
              </tr>
            </table>

            <p style="font-size:12px;color:#94a3b8;text-align:center;margin-top:10px;">
              Tautan aplikasi PWA: <a href="${data.scannerUrl}" style="color:#3b82f6;text-decoration:none;">${data.scannerUrl}</a>
            </p>
          </td>
        </tr>
